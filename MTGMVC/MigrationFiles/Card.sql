CREATE TABLE [Card](
  ...
  ,[preview]           VARCHAR(30)
  ,[prices]            VARCHAR(30)
  ,[related_uris]      VARCHAR(30)
  ,[purchase_uris]     VARCHAR(30)
  ,[produced_mana]     VARCHAR(30)
);
INSERT INTO mytable(object,id,oracle_id,multiverse_ids,mtgo_id,arena_id,tcgplayer_id,cardmarket_id,name,lang,released_at,uri,scryfall_uri,layout,highres_image,image_status,image_uris,mana_cost,cmc,type_line,oracle_text,power,toughness,colors,color_identity,keywords,legalities,games,reserved,foil,nonfoil,finishes,oversized,promo,reprint,variation,set_id,set,set_name,set_type,set_uri,set_search_uri,scryfall_set_uri,rulings_uri,prints_search_uri,collector_number,digital,rarity,card_back_id,artist,artist_ids,illustration_id,border_color,frame,full_art,textless,booster,story_spotlight,edhrec_rank,preview,prices,related_uris,purchase_uris,produced_mana) VALUES (NULL,NULL,NULL,NULL,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,'false',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'false','false','false',NULL,'false','false','false','false',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'false',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'false','false','false','false',0,NULL,NULL,NULL,NULL,NULL);
